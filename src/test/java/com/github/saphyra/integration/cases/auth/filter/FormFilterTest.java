...
@ContextConfiguration(classes = {AuthConfiguration.class, FormFilterTest.class})
public class FormFilterTest {
    ...
    private static final String FORBIDDEN_REDIRECTION = "forbidden_redirection";
    ...
    public void accessAllowedUri() throws Exception {
        //WHEN
        MockHttpServletResponse response = mockMvcWrapper.postRequest(ALLOWED_URI_MAPPING, false, null);
        //THEN
    ...
    public void accessProtectedUriWithAllowedPath() throws Exception {
        //WHEN
        MockHttpServletResponse response = mockMvcWrapper.putRequest(PROTECTED_URI_MAPPING, false, null);
        //THEN
    ...
    public void accessProtectedUriWithoutLogin() throws Exception {
        ...
        //WHEN
        MockHttpServletResponse response = mockMvcWrapper.postRequest(PROTECTED_URI_MAPPING, false, null);
        //THEN
    ...
    private void givenUnauthorizedResponse() {
        given(errorResponseResolver.getRedirectionPath(any())).willReturn(UNAUTHORIZED_REDIRECTION);
    }

    private void givenForbiddenResponse() {
        given(errorResponseResolver.getRedirectionPath(any())).willReturn(FORBIDDEN_REDIRECTION);
    }

    private void verifyUnauthorized(MockHttpServletResponse response) {
        responseValidator.verifyRedirection(response, UNAUTHORIZED_REDIRECTION);
    }

    private void verifyForbidden(MockHttpServletResponse response) {
        responseValidator.verifyRedirection(response, FORBIDDEN_REDIRECTION);
    }
